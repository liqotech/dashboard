...
function AvailablePeer(props) {
  ...
  if (
    props.foreignCluster.status &&
    props.foreignCluster.status.outgoing.advertisement
  ) {
  ...
  if (
    props.foreignCluster.status &&
    props.foreignCluster.status.incoming.peeringRequest
  ) {
              ...
              <Row align={'middle'}>
                <Col flex={2}>
                  <Typography.Text type={'secondary'}>
                    {props.refused
                      ? props.reason
                      : props.foreignCluster.spec.discoveryType}
                    {loading && !props.refused ? (
                      <span>
                        , <>{props.reason ? props.reason : 'connecting...'}</>
                      </span>
                    ) : null}
                  </Typography.Text>
                </Col>
