...
describe('ConnectedPeer', () => {
  ...
  test(
    'List of connected peers shows not incoming',
    async () => {
  ...
  test(
    'List of connected peers shows not outgoing',
    async () => {
  ...
  test(
    'List of connected peers show if no advertisement',
    async () => {
  ...
  test(
    'List of connected peers show if no peering request',
    async () => {
  ...
  test(
    "List of connected peers doesn't show if no peering request and no advertisement",
    async () => {
  ...
  test(
    'Advertisement status is not accepted',
    async () => {
  ...
  test(
    "Dropdown menu don't activate collapse",
    async () => {
      jest.clearAllMocks();
